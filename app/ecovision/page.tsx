// EcoVision Home Page migrated from index.html
...
export default function EcoVisionHome() {
  return (
    <main style={{ fontFamily: "'Playfair Display', Georgia, serif", background: "#000", minHeight: "100vh" }}>
      {/* TODO: Add background slideshow and hero section as React/Next.js components */}
      <div className="flex flex-col items-center justify-center min-h-screen text-white">
        ...
        {/* Add navigation links to other EcoVision pages here */}
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <a href="/ecovision/radar" className="rounded-lg bg-purple-600 px-6 py-3 font-bold hover:bg-purple-700 transition">Radar</a>
