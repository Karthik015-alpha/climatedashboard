  ...
  return (
    <div className="relative mb-7 overflow-hidden rounded-3xl bg-gradient-to-r from-blue-500 via-cyan-500 to-emerald-500 p-7 shadow-2xl">
      ...
      <div className="relative z-10 space-y-3">
        <Link href={backTo} className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/20 px-4 py-2 text-xs font-bold uppercase text-white/90 backdrop-blur transition hover:bg-white/30">
          <ArrowLeft size={14} />
          {backLabel}
        </Link>
